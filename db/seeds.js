...
const petitionData = [{
  label: 'Scrap smart motorways and bring back permanent hard shoulders',
  ...
  label: 'Call on PM to take action to build public trust in the Grenfell Tower Inquiry',
